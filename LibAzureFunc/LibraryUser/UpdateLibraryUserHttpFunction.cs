...
namespace LibAzureFunc.LibraryUser
{
    ...
    public class UpdateLibraryUserHttpFunction
    {
        private readonly IAccessTokenProvider _tokenProvider;
        private readonly ILibraryUserWebApiManager _libraryUserWebApiManager;

        public UpdateLibraryUserHttpFunction(IAccessTokenProvider tokenProvider, ILibraryUserWebApiManager libraryUserWebApiManager)
        {
            _tokenProvider = tokenProvider;
            _libraryUserWebApiManager = libraryUserWebApiManager;
        }

        [FunctionName("UpdateLibraryUserHttpFunction")]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "put", Route = "updatelibraryuser")] HttpRequest req, ILogger log)
        {
            ...
            try
            {
                ...
                if (model != null)
                {
                    ...
                    retVal = _libraryUserWebApiManager.UpdateLibraryUser(model);
                }
