...
namespace DataAccess.WebApiRepository
{
    using System;
    ...
    public abstract class RepositoryBase
    {
        ...
        protected RepositoryBase(string connectionString, string serverType)
        {
        ...
        protected IDbConnection OpenConnection()
        {
            ...
            if (string.Equals(_serverType, "MySQL", StringComparison.OrdinalIgnoreCase))
            {
        ...
        protected void ExecuteSaveProcedure(
            ...
            object parameters,
            IDbConnection connection,
            List<OutputParam> outputParameters = null,
            IDbTransaction transaction = null)
        {
            var dynamicParameters = new DynamicParameters(parameters);
